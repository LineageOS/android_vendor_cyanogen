...
# Inherit CM device configuration for droid2.
$(call inherit-product, device/motorola/droid2/droid2.mk)

# Extra droid2 overlay
...
#PRODUCT_SPECIFIC_DEFINES += TARGET_KERNEL_CONFIG=cyanogen_droid2_defconfig
