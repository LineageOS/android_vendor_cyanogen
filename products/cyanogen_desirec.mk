...
# Inherit cm device configuration for desirec.
$(call inherit-product, device/htc/desirec/device_desirec.mk)

# Extra desirec overlay
...
#PRODUCT_SPECIFIC_DEFINES += TARGET_KERNEL_CONFIG=cyanogen_desirec_defconfig

# Copy mdpi specific prebuilt files
PRODUCT_COPY_FILES +=  \
    vendor/cyanogen/prebuilt/mdpi/media/bootanimation.zip:system/media/bootanimation.zip

# Extra heroc overlay (for Gallery3D orientation hack)
