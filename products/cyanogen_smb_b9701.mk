...
# Inherit CM device configuration for smb_b9701.
$(call inherit-product, device/malata/smb_b9701/smb_b9701.mk)

# Extra smb_b9701 overlay
PRODUCT_PACKAGE_OVERLAYS += vendor/cyanogen/overlay/smb_b9701
...
PRODUCT_BUILD_PROP_OVERRIDES += PRODUCT_NAME=smb_b9701 BUILD_ID=GRJ22 BUILD_DISPLAY_ID=GRK39C BUILD_FINGERPRINT=google/passion/passion:2.3.4/GRJ22/121341:user/release-keys PRIVATE_BUILD_DESC="passion-user 2.3.4 GRJ22 121341 release-keys"
...
#PRODUCT_SPECIFIC_DEFINES += TARGET_KERNEL_CONFIG=cyanogen_smb_b9701_defconfig
